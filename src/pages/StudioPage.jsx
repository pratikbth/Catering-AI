...
export default function StudioPage() {
  ...
  const handleTemplateRefSelect = useCallback((template) => {
    setReferenceImage({
      ...
      preview: template.thumbnailUrl || template.thumbnail || null,
      name: `Template: ${template.title}`,
      templateId: template.id,
      thumbnailUrl: template.thumbnailUrl || template.thumbnail || null,
    });
  ...
  const handleAddToMoodboard = useCallback((imageData, prompt) => {
    setMoodboardImages((prev) => [
      ...prev,
      {
        ...
        prompt: prompt,
        filters: { atmosphere: filters.atmosphere, budget: filters.budget },
